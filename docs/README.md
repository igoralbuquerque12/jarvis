...
[![Tests](https://img.shields.io/badge/tests-Jest-99424F?logo=jest&logoColor=white)](#testes-e-qualidade)

</div>

---

> **Mapa da documentação:** você está no manual do projeto completo. Para detalhes de implementação e comandos de cada aplicação, consulte [Server](../server/README.md) e [Web](../web/README.md).
...
| Testes | **Jest 30** + ts-jest, supertest | Testes unitários junto aos módulos e testes e2e em `server/test/`. |
...
├── compose.yml                # Toda a plataforma (9 serviços, 2 redes, 3 volumes)
...
| Documento | Conteúdo |
|---|---|
| [`server/README.md`](../server/README.md) | **Backend apenas**: NestJS, módulos, banco, APIs, comandos e desenvolvimento local. |
| [`web/README.md`](../web/README.md) | **Frontend apenas**: React/Vite, páginas, integração HTTP, comandos e build. |
